...
class ColorsManager {
  ...
  static const Color lightSecondary = Color(0xff3C3C43);
  static const Color lightTertiary = Color(0xff3C3C43);
  static const Color lightQuaternary = Color(0xff3C3C43);
  ...
  static const List<Color> linearGradient2 = [
    Color(0xff5936B4),
    Color(0xff362A84),
  ];
  static const List<Color> radialGradient = [
    Color(0xff3658B1),
    Color(0xffC159EC),
    Color(0xffAEC9FF),
    Color(0xff083072),
  ];
  static const List<Color> angularGradient = [
    Color(0xffF7CBFD),
    Color(0xff7758D1),
    Color(0xff612FAB),
  ];
  ...
  static const Color greyishWhite = Color(0xffEBEBF5);
  static const Color darkPurple = Color(0xff312B5B);
}
